...
@include('member.layout.menu')
        <div class="content">
            <div class="content-header">
                <span>專案管理</span> &gt; <label>專案新增</label>
            </div>
            <form method='post' action='/member/project/create' class='form1'>
                ...
                <h5>開放與否:</h5>
                <p>
                    <input type="radio" name="isPublic" id="open" value="1" checked />
                    <label for="open" >開放</label>
                    <input type="radio" name="isPublic" id="stop" value="0"  />
